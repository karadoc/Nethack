 ...
 */
	...
	A(ATTK(AT_BITE, AD_PHYS, 1, 8), ATTK(AT_BREA, AD_COLD, 2, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	A(ATTK(AT_BITE, AD_PHYS, 2, 6), ATTK(AT_BREA, AD_COLD, 3, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	A(ATTK(AT_BITE, AD_PHYS, 2, 6), ATTK(AT_BREA, AD_FIRE, 3, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	A(ATTK(AT_BITE, AD_PHYS, 3, 6), ATTK(AT_BREA, AD_FIRE, 4, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
 ...
 */
	...
	A(ATTK(AT_EXPL, AD_FIRE, 7, 6), NO_ATTK, NO_ATTK,
	    NO_ATTK, NO_ATTK, NO_ATTK),
	...
	LVL(6, 13, 4, 0, 0), (G_NOCORPSE|G_GENO|2),
	A(ATTK(AT_EXPL, AD_ELEC, 7, 6), NO_ATTK, NO_ATTK,
	  NO_ATTK, NO_ATTK, NO_ATTK),
 ...
 */
	...
	A(ATTK(AT_ENGL, AD_ELEC, 2, 6), ATTK(AT_ENGL, AD_DREN, 2, 4), // K-Mod energy drain use to be d(0,0). wtf, I say.
 ...
 */
	...
	A(ATTK(AT_BITE, AD_PHYS, 2, 8), ATTK(AT_ENGL, AD_DGST, 4,10),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
...
*/
	...
	LVL(15, 9, -2, 20, 4), (G_GENO|1),
	A(ATTK(AT_BREA, AD_MAGM, 4, 6), ATTK(AT_BITE, AD_PHYS, 3, 8), // Will be AD_CONF, probably.
	  ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
	  NO_ATTK, NO_ATTK),
	SIZ(WT_DRAGON, 1500, 0, MS_ROAR, MZ_GIGANTIC), 0, 0,
	M1_FLY|M1_THICK_HIDE|M1_NOHANDS|M1_SEE_INVIS|M1_OVIPAROUS|
	...
	LVL(16, 9, -2, 20, -4), (G_GENO|1),
	A(ATTK(AT_BREA, AD_FIRE, 6, 6), ATTK(AT_BITE, AD_FIRE, 3, 8),
	  ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
	  NO_ATTK, NO_ATTK),
	...
	A(ATTK(AT_BREA, AD_COLD, 6, 6), ATTK(AT_BITE, AD_COLD, 3, 8),
	  ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
	  NO_ATTK, NO_ATTK),
	...
	LVL(16, 9, -2, 20, -6), (G_GENO|1),
	A(ATTK(AT_BREA, AD_DISN, 4,10), ATTK(AT_BITE, AD_ACID, 3, 8), // disintergrating bite is just too harsh
	  ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
	  NO_ATTK, NO_ATTK),
	...
	LVL(16, 9, -2, 20, -7), (G_GENO|1),
	A(ATTK(AT_BREA, AD_ELEC, 6, 6), ATTK(AT_BITE, AD_ELEC, 3, 8),
	  ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
	  NO_ATTK, NO_ATTK),
	...
	LVL(16, 9, -2, 20, 6), (G_GENO|1),
	A(ATTK(AT_BREA, AD_DRST, 6, 6), ATTK(AT_BITE, AD_DRST, 3, 8),
	  ATTK(AT_CLAW, AD_DRST, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
	  NO_ATTK, NO_ATTK),
	...
	LVL(16, 9, -2, 20, 7), (G_GENO|1),
	A(ATTK(AT_BREA, AD_ACID, 6, 6), ATTK(AT_BITE, AD_ACID, 3, 8),
	  ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
	  NO_ATTK, NO_ATTK),
 ...
 */
	...
	LVL(16, 12, -1, 10, -3), (G_GENO|G_SGROUP|1),
	A(ATTK(AT_WEAP, AD_PHYS, 2, 12),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
 ...
 */
	...
	LVL(16, 18, -6, 80, -10), (G_NOGEN|G_NOCORPSE|G_UNIQ),
	A(ATTK(AT_WEAP, AD_PHYS, 2, 8), ATTK(AT_BITE, AD_DRLI, 3, 5),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_VAMPIRE, MZ_HUMAN), MR_SLEEP|MR_POISON, 0,
 ...
 */
	...
	LVL(12, 8, 2, 0, 0), (G_NOCORPSE|G_NOGEN),
 ...
 */
	...
	M1_HUMANOID|M1_OMNIVORE,
	M2_NOPOLY|M2_HUMAN|M2_PEACEFUL|M2_STRONG|M2_COLLECT|M2_MAGIC|M2_GREEDY,
	M3_INFRAVISIBLE, HI_DOMESTIC),
    MON("guard", S_HUMAN,
	...
	M3_INFRAVISIBLE, CLR_WHITE),
	// Note, ac of soldiers is primarily determined by their equipment,
	// which is assigned in m_initinv().
// K-Mod, soldiers use to have moves = 10; ac = 10; lv = {6, 8, 10, 12}; mc = {0, 5, 15, 15}
    MON("soldier", S_HUMAN,
...
#undef SEDUCTION_ATTACKS
	...
	M3_INFRAVISIBLE|M3_INFRAVISION, CLR_RED),
    MON("balrog", S_DEMON,
	LVL(18, 12, -6, 75, -14), (G_HELL|G_NOCORPSE|1),
	A(ATTK(AT_WEAP, AD_FIRE, 8, 4), ATTK(AT_WEAP, AD_PHYS, 4, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_SILENT, MZ_LARGE), MR_FIRE|MR_POISON, 0,
	 ...
	 */
    MON("Juiblex", S_DEMON,
	LVL(50, 6, -10, 65, -15), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
 ...
 */
	...
	A(ATTK(AT_WEAP, AD_PHYS, 1, 8), ATTK(AT_WEAP, AD_PHYS, 1, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_HUMANOID, MZ_HUMAN), /* MR_COLD */ 0, 0, // removed cold immunity
	M1_HUMANOID|M1_OMNIVORE,
	M2_NOPOLY|M2_HUMAN|M2_STRONG|M2_FEMALE|M2_COLLECT, M3_INFRAVISIBLE,
	HI_DOMESTIC),
    MON("wizard", S_HUMAN,
 ...
 */
	...
	LVL(17, 12, -2, 30, -14), (G_NOGEN|G_UNIQ),
    ...
    MON("Ixoth", S_DRAGON,
	LVL(15, 12, -2, 20, -14), (G_NOGEN|G_UNIQ),
