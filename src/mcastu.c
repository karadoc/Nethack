 ...
 */
	...
	switch (mattk->adtyp) {
		...
		if(Fire_resistance) {
			shieldeff(u.ux, u.uy);
			pline("But you resist %sthe effects.", Fire_immunity? "" : "some of ");
		...
		if(Cold_resistance) {
			shieldeff(u.ux, u.uy);
			pline("But you resist %sthe effects.", Cold_immunity? "" : "some of ");
