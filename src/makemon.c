...
** rebalanced max monster level
*/
		/* original code
	    maxmlev = (zlevel + u.ulevel) / 2;*/
/* I have two main aims for implimenting this change.
...
2) I want to discourage dilly-dallying (farming, long periods of polypiling, etc). I want the game to pick up pace. */
		maxmlev = (2*zlevel + u.ulevel+1 + moves/1500) / 4; // zlevel/2 + ulevel/4 + moves/6000, +1 just to get > 0
