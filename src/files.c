...
# endif /* MICRO */
		...
		if (!strcmpi("norep", msgtype)) typ = MSGTYP_NOREP;
		else if (!strcmpi("hide", msgtype)) typ = MSGTYP_NOSHOW;
		else if (!strcmpi("noshow", msgtype)) typ = MSGTYP_NOSHOW;
		else if (!strcmpi("more", msgtype)) typ = MSGTYP_STOP;
		else if (!strcmpi("stop", msgtype)) typ = MSGTYP_STOP;
