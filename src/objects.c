...
WEAPON("dwarvish short sword", "broad short sword",
	0, 0, 0,  6, 25, 10,  7,  8, 0, P,   P_SHORT_SWORD, IRON, HI_METAL),
WEAPON("silver short sword", (char *)0, // K-Mod: new weapon
	0, 0, 0,  4, 25, 10,  7,  8, 0, P,   P_SHORT_SWORD, SILVER, HI_SILVER),
...
WEAPON("elven broadsword", "runed broadsword",
	0, 0, 0,  6, 40, 10,  6,  6, 0, S,   P_BROAD_SWORD, WOOD, HI_WOOD),
						/* +d4 small, +1 large */
WEAPON("long sword", (char *)0,
	1, 0, 0, 30, 40, 15,  8, 12, 0, S,   P_LONG_SWORD, IRON, HI_METAL),
