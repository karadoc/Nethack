...
WEAPON("orcish spear", "crude spear",
	0, 1, 0, 15, 35,  3,  6,  8, 0, P,   P_SPEAR, IRON, CLR_BLACK),
...
WEAPON("orcish dagger", "crude dagger",
	0, 1, 0, 12, 15,  4,  4,  3, 2, P,   P_DAGGER, IRON, CLR_BLACK),
...
WEAPON("orcish short sword", "crude short sword",
	0, 0, 0,  7, 35, 10,  6,  8, 0, P,   P_SHORT_SWORD, IRON, CLR_BLACK),
...
ARMOR("plate mail", (char *)0,
	1, 0, 1, 0,	44, 5, 400, 600,  3, 2, ARM_SUIT, IRON, HI_METAL),
ARMOR("crystal plate mail", (char *)0,
	1, 0, 1, 0,	10, 5, 400, 820,  3, 2, ARM_SUIT, GLASS, CLR_WHITE),
#ifdef TOURIST
ARMOR("bronze plate mail", (char *)0,
	1, 0, 1, 0,	25, 5, 400, 400,  4, 0, ARM_SUIT, COPPER, HI_COPPER),
#else
ARMOR("bronze plate mail", (char *)0,
...
ARMOR("banded mail", (char *)0,
	1, 0, 1, 0,	72, 5, 310,  90,  4, 0, ARM_SUIT, IRON, HI_METAL),
...
ARMOR("chain mail", (char *)0,
	1, 0, 0, 0,	72, 5, 270,  75,  5, 1, ARM_SUIT, IRON, HI_METAL),
ARMOR("orcish chain mail", "crude chain mail",
	0, 0, 0, 0,	20, 5, 270,  75,  6, 1, ARM_SUIT, IRON, CLR_BLACK),
ARMOR("scale mail", (char *)0,
	1, 0, 0, 0,	72, 5, 225,  45,  6, 0, ARM_SUIT, IRON, HI_METAL),
ARMOR("studded leather armor", (char *)0,
	1, 0, 0, 0,	72, 3, 200,  15,  7, 1, ARM_SUIT, LEATHER, HI_LEATHER),
ARMOR("ring mail", (char *)0,
	1, 0, 0, 0,	72, 5, 225, 100,  7, 0, ARM_SUIT, IRON, HI_METAL),
ARMOR("orcish ring mail", "crude ring mail",
	0, 0, 0, 0,	20, 5, 225,  80,  8, 1, ARM_SUIT, IRON, CLR_BLACK),
