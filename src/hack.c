...
** Levitation shouldn't help in the water level.
**/
	/* original code
	...
	if (is_pool(u.ux, u.uy) || is_lava(u.ux, u.uy))
	{
		if (!u.ustuck && (Is_waterlevel(&u.uz) || (!Levitation && !Flying)))
		{
// K-Mod end [I dislike the 'style' of nethack code...]
#ifdef STEED
...
int effect_strength;
{
	if (uarmh && uarmh->otyp == HELM_OF_ANTI_MAGIC)
	{
