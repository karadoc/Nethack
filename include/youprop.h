...
** Added new concept: distiction between resistance and immunity.
** (Changes will be made throughout the code without further comments)
**/
...
#define Fire_immunity		(EFire_resistance || resists_fire(&youmonst)) // K-Mod

#define HCold_resistance	u.uprops[COLD_RES].intrinsic
#define ECold_resistance	u.uprops[COLD_RES].extrinsic
#define Cold_resistance		(HCold_resistance || ECold_resistance || \
				 resists_cold(&youmonst))
#define Cold_immunity		(ECold_resistance || resists_cold(&youmonst)) // K-Mod
...
#define Shock_immunity		(EShock_resistance || resists_elec(&youmonst)) // K-Mod

#define HPoison_resistance	u.uprops[POISON_RES].intrinsic
#define EPoison_resistance	u.uprops[POISON_RES].extrinsic
#define Poison_resistance	(HPoison_resistance || EPoison_resistance || \
				 resists_poison(&youmonst))
#define Poison_immunity		(EPoison_resistance || resists_poison(&youmonst)) // K-Mod
