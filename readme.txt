This is K-Mod, version 0.7, a nethack mod that focuses on improving balance.
...
+ Silver short sword
+ 'Gungnir', the silver spear artifact.
...
+ The bite attack of dragons now has a special effect for each dragon type. Red: fire, white: cold, blue: electric, yellow: acid, black: acid as well (disintergration might be a bit too harsh), orange: paralysis, gray: stun, green: poison, silver: no special effect. So watch out. Blue and orange are particularly dangerous.
...
The source code for this project can be downloaded from http://sourceforge.net/projects/k-mod/
